...
const Approach: React.FC = () => {
  ...
  return (
    <main 
      ...
      style={{
        backgroundImage: `linear-gradient(135deg, rgba(44, 62, 80, 0.9) 0%, rgba(52, 73, 94, 0.88) 100%), url('https://images.unsplash.com/photo-1448375240586-882707db888b?q=80&w=2000')`,
        minHeight: '100vh',
